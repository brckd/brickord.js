...
export async function getMember(message: Message, query: string) {
...
export function getChannel(message: Message, query: string) {
...
export function getRole(message: Message, query: string) {
...
export function getMentionable(message: Message, query: string) {
    try {
