...
exports.BrickordClient = void 0;
const discord_js_1 = require("discord.js");
const __1 = require("..");
const path_1 = require("path");
class BrickordClient extends discord_js_1.Client {
    constructor(options) {
        var _a, _b, _c;
        super(options);
    ...
    login(token) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield _super.login.call(this, token);
            }
            catch (err) {
                if (err instanceof Error && err.name == 'Error [TOKEN_INVALID]')
                    throw new __1.InvalidToken();
            }
            return '';
        });
    }
}
exports.BrickordClient = BrickordClient;
